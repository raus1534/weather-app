...
const NavSearch: React.FC<Props> = ({ onLocationSelect }) => {
  ...
  return (
    <div className="flex items-center justify-between w-full p-4 bg-white shadow-md rounded-lg">
      <div className="flex md:flex-row flex-col items-center space-x-2 justify-center">
        <Image src={logo} alt="Logo" width={40} height={40} />
        {/* Replace with your logo path */}
        <h1 className="md:text-xl text-xs font-semibold leading-none md:text-left text-center">
          {`What's the `}
          <br /> Weather !?
        </h1>
      </div>
